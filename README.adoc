...
The main branch is using `spring-boot 3.4.x` and `spring-cloud 2024.x.x`. Check https://github.com/spring-cloud-services-samples/greeting/tree/spring-boot-2.7[spring-boot-2.7] branch for older versions.
