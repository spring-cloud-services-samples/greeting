...
The main branch is using `spring-boot 3.0.1` and `spring-cloud 2022.0.0`. Check https://github.com/spring-cloud-services-samples/greeting/tree/spring-boot-2.7[spring-boot-2.7] branch for older versions.
